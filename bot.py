...
async def start_countdown_for_round(context):
    ...
    for u in current_round_players:
        try:
            ...
            # ✅ Updated line — disable reactions for this message only
            await context.bot.send_message(
                players[u]["chat_id"],
                "🚀 Start tapping! 10 seconds go!",
                reply_markup=markup,
    ...
    # Manual leaderboard posting in group (admin will post manually)
    ...
    await context.bot.send_message(ADMIN_ID, f"🏆 Winner: @{winner}\n📊 Results:\n{result}")
    await context.bot.send_message(ADMIN_ID, "Waiting for next round players…")
